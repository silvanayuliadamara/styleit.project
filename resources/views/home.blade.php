        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <div class="hero-actions">
                    <a href="{{ route('layanan.index') }}" class="btn-dark-custom">Lihat Layanan <i class="bi bi-arrow-right"></i></a>
                    <a href="{{ route('pricelist') }}" class="btn-outline-custom">Pesan Sekarang <i class="bi bi-arrow-right"></i></a>
                </div>
        ...
        <div class="row g-4">
            @foreach($categories as $category)
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('layanan.kategori', $category->slug) }}" class="service-card h-100">

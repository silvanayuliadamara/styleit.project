...
<section class="page-hero">
    <div class="container text-center">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="page-logo">
...
<?php echo $__env->make('layouts.app', ['title' => 'Profil Usaha - Lisa Yuli Belti'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\PHP\styleit.project\resources\views/profil.blade.php ENDPATH**/ ?>